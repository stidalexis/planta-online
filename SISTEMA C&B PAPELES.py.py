...
# ESPECIFICACIONES GENERALES Y ACABADOS 
    ...
    pdf.set_font("Arial", "B", 10); pdf.cell(25, 7, " Numeración: ", 1, 0, fill=True)
    pdf.set_font("Arial", "", 10);  pdf.cell(70, 7, f"DEL-  {row.get('num_id','NO')}", 1, 0)
    pdf.set_font("Arial", "B", 10); pdf.cell(25, 7, " Numeración: ", 1, 0, fill=True)
    pdf.set_font("Arial", "", 10);  pdf.cell(70, 7, f"AL-  {row.get('num_fd','')}", 1, 1)
