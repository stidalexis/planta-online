...
# ESPECIFICACIONES GENERALES Y ACABADOS 
    ...
    pdf.set_font("Arial", "", 10);  pdf.cell(40, 7, f"{row.get('cantidad_formas','')}", 1, 0)
    ...
    pdf.set_font("Arial", "", 10);  pdf.cell(40, 7, f"{row.get('presentacion2', 'N/A')}", 1, 0)
    pdf.set_font("Arial", "B", 10); pdf.cell(30, 7, " Numeración: ", 1, 0, fill=True)
    pdf.set_font("Arial", "", 10);  pdf.cell(95, 7, f"DEL-  {row.get('num_id','NO')} AL-  {row.get('num_fd','')}", 1, 1)
    ...
    pdf.set_font("Arial", "B", 10); pdf.cell(25, 7, " Destino: ", 1, 0, fill=True)
    pdf.set_font("Arial", "", 10);  pdf.cell(165, 7, f"{row.get('destino_formas','NO APLICA')}", 1, 1)
