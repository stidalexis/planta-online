...
with st.sidebar:
    st.image("https://cdn-icons-png.flaticon.com/512/2268/2268710.png", width=100) # Un icono de fábrica
    st.title("SISTEMA NUVE")
    # Este radio botón es el que cambiará entre pantallas
    pagina = st.radio("Seleccionar Módulo:", ["🚀 Producción y Monitor", "📊 Control Supervisor (Hora a Hora)"])
    st.divider()
    st.info("Usuario: Supervisor de Planta")

# --- LÓGICA DE PÁGINAS ---
if pagina == "🚀 Producción y Monitor":
    # Aquí es donde "encerraremos" todo tu código actual más adelante
    st.info("Cargando Panel de Producción...")
...
# descarga excel de  historial
    ...
    st.title("Módulo de Control Horario")
    st.write("Aquí configuraremos el formulario que me pediste.")
